...
Existem vários modelos de STB, variando dos modelos mais simples, criados para apenas apresentação de conteúdo simples, até STBs mais sofisticados com várias aplicações já prontas para uso na memória. O foco, na maioria dos casos, está em aplicações de streaming (TV Digital, Netflix, etc)

\section{Estilos de Tetris}

O jogo Tetris foi originalmente desenvolvido por Alexey Pajitnov, em 1985. Foi desenvolvido enquanto ele trabalhava para a Academia Soviética de Ciências em Moscou. Pajitnov, um entusiasta em quebra-cabeças, começou a trabalhar em um jogo, simulando seu jogo favorito, pentominos. Com o passar do tempo, os pentominos foram transformados em tetraminos, provavelmente devido a dificuldades encontradas na implementação. Este novo formato também trouxe novas regras: os tetraminos cairiam em um poço, e o jogador deveria tentar alocá-los no poço a fim de eliminá-los. Esta primeira versão foi criada usando Pascal para Eletronica 60, e consistia de colchetes e gráficos em preto e branco. Foi, mais tarde, portado para IBM PC por Vadim Gerasimov. O jogo "viralizou" em pouco tempo. Segundo o autor, em duas semanas, a maioria dos proprietários de PC já tinham uma cópia do jogo, expandindo-se para a Europa mais tarde.
